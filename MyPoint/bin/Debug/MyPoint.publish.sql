...
GO
:setvar DatabaseName "MyPointDB"
:setvar DefaultFilePrefix "MyPointDB"
...
GO
PRINT N'테이블 [dbo].[Points]을(를) 만드는 중...';
...
GO
PRINT N'테이블 [dbo].[PointsLogs]을(를) 만드는 중...';
...
GO
PRINT N'DEFAULT 제약 조건 [dbo].[Points]에 대한 명명되지 않은 제약 조건을(를) 만드는 중...';


GO
ALTER TABLE [dbo].[Points]
    ADD DEFAULT (0) FOR [totalPoint];


GO
PRINT N'DEFAULT 제약 조건 [dbo].[PointsLogs]에 대한 명명되지 않은 제약 조건을(를) 만드는 중...';


GO
ALTER TABLE [dbo].[PointsLogs]
    ADD DEFAULT (0) FOR [totalPoint];
